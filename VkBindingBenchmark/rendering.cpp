...
void loadUBOTestMaterial(vkh::VkhContext &ctxt, int num) {
  ...
  vkh::createBasicMaterial(VERT_SHADER_NAME, "./shaders/random_frag.frag.spv", ctxt, createInfo);
#else
  vkh::createBasicMaterial(VERT_SHADER_NAME, "./shaders/debug_normals.frag.spv", ctxt, createInfo);
#endif
...
#if WITH_COMPLEX_SHADER
  vkh::createBasicMaterial("./shaders/common_vert.vert.spv", "./shaders/random_frag.frag.spv",
                           ctxt, createInfo);
#else
  vkh::createBasicMaterial("./shaders/common_vert.vert.spv", "./shaders/debug_normals.frag.spv",
                           ctxt, createInfo);
#endif
}
